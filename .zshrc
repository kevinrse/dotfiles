...
__conda_setup="$('/home/kmf76/miniconda2/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/kmf76/miniconda2/etc/profile.d/conda.sh" ]; then
        . "/home/kmf76/miniconda2/etc/profile.d/conda.sh"
    else
